...
public class EmployeeController implements Serializable {
    ...
    @EJB private ejb.EmployeeFacade ejbFacade;
    ...
    public static class EmployeeControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Employee) {
                ...
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: "+EmployeeController.class.getName());
            }
        }
